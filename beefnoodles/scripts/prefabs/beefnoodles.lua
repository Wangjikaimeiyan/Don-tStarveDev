...
local function MakePreparedFood(data)
	...
	if data.overridebuild then
        ...
        table.insert(foodassets, Asset("ATLAS", "images/"..data.name..".xml"))
        table.insert(foodassets, Asset("IMAGE", "images/"..data.name..".tex"))
	end
...
for k, v in pairs(require("beefnoodles")) do
